/**
 * Script to initialize database with all required functions
...
async function initDatabase() {
  ...
  try {
    ...
    console.log('📝 Creating category functions...')
    await client.query(`
    ...
    console.log('✅ Category functions created')

    // Create get_latest_reading function
    console.log('📝 Creating get_latest_reading function...')
    await client.query(`
      ...
      $$ LANGUAGE plpgsql;
    `)
    console.log('✅ get_latest_reading function created')

    // Create get_historical_data function
    console.log('📝 Creating get_historical_data function...')
    await client.query(`
      ...
      $$ LANGUAGE plpgsql;
    `)
    console.log('✅ get_historical_data function created')
